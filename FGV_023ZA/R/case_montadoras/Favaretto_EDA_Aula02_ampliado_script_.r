...
#  MBA FGV - Turma Live 023ZA (FGV Online) - Aula 02 ampliado
#
...
#----------
# Há MUITOS recursos gráficos no software R!
#----------
...
#  #  Uso para finalidade didática em aula expositiva 
#
#  Prof. Dr. José Favaretto - ver. 1.1 | maio/2023 
#  www.favaretto.net
#
#-------------------------------
#
...
# para instalar vários pacotes de uma só vez, use o comando 'combine'
install.packages(c("dplyr", "readr", "readxl", "ggplot2"))

# comando "c(" Combine Values into a Vector or List
...
#----------------------------
#   Término do script da Aula 02 - ampliado
#----------------------------
